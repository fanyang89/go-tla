...
and private-array/literal-input/owned-reference computations bring the local semantic total to **166**.
...
Latest full-self prerequisite logs: `$HOME/tmp/pi/gotla-self-bootstrap-references/{gate,race}.log`.
