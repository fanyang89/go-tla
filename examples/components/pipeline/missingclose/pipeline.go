// Package missingclose intentionally omits the transformation stage's completion signal.
package missingclose
...
func double(input <-chan int, output chan<- int) {
	...
	// BUG: downstream waits forever for output closure.
}
