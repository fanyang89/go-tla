...
and data-computation, owned-reference/value-copy, open-global and array-range proofs bring the local semantic total to **185**.
...
Latest full-self prerequisite logs: `$HOME/tmp/pi/gotla-self-bootstrap-array-ranges/{gate,race}.log`.
Value-copy logs remain under `gotla-self-bootstrap-value-copies/`.
