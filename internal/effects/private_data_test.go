...
func TestPrivateDataConstructorSummaries(t *testing.T) {
	for _, tc := range []struct {
		...
		{"array-channel-elements", "", `func ctor()any{p:=new([2]chan int);p[1]=nil;return p}`, effects.Pure},
		{"array-mutex-elements", `import "sync"`, `func ctor()any{p:=new(struct{a [2]sync.Mutex;n int});p.n=1;return p}`, effects.Pure},
		...
		{"pointer-field", "", `func ctor()any{return &struct{p *int;n int}{n:1}}`, effects.Pure},
		{"interface-field", "", `func ctor()any{return &struct{p any;n int}{n:1}}`, effects.Pure},
		{"channel-field", "", `func ctor()any{return &struct{ch chan int;n int}{n:1}}`, effects.Pure},
		{"function-field", "", `func ctor()any{return &struct{f func();n int}{n:1}}`, effects.Pure},
		{"mutex-field", `import "sync"`, `func ctor()any{return &struct{mu sync.Mutex;n int}{n:1}}`, effects.Pure},
