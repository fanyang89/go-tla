...
and private-array computations bring the local semantic total to **154**.
...
Latest full-self prerequisite logs: `$HOME/tmp/pi/gotla-self-bootstrap-array-data/{gate,race}.log`.
